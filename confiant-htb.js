...
var PartnerSpecificValidator = require('confiant-htb-validator.js');
...
function ConfiantHtb(configs) {
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'ConfiantHtb', // PartnerName
            namespace: 'ConfiantHtb', // Should be same as partnerName
            statsId: 'CONFI', // Unique partner identifier
            version: '2.1.1',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
